...
class AppThemeData {
  ...
  static final tabItemTitleTextStyle = GoogleFonts.roboto(
    fontSize: 16,
  ...
  static const ColorScheme darkColorScheme = ColorScheme(
    // This is the default color for buttons and many widgets.
    primary: Color(0xFF66fff4),
    ...
    // Contrasts with primary color.
    onPrimary: Colors.black,
    // onPrimary: _darkFillColor, // previous color

    // Contrasts with secondary color
    onSecondary: _darkFillColor,

    // Contrasts with surface color
